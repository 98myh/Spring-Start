...
import org.zerock.ex6.entity.QMovie;
import org.zerock.ex6.entity.QMovieImage;
import org.zerock.ex6.entity.QReview;
...
public class SearchMovieRepositoryImpl extends QuerydslRepositorySupport implements SearchMovieRepository {
	...
	public Movie search1() {
		...
		JPQLQuery<Tuple> tuple = jpqlQuery.select(movie, movieImage, review.count());
		tuple.groupBy(movieImage);
